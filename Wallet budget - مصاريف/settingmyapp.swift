...
//                        
//                        AppListItem(
//                                            title: languageManager.isArabic ? "الطقس" : "Weather",
//                                            subtitle: languageManager.isArabic ? "توقعات الطقس الدقيقة" : "Accurate Weather Forecast",
//                                            iconName: "weather",
//                                            appId: "id1492430426",
//                                            colors: colors
//                                        )
//                                        
//                                        AppListItem(
//                                            title: languageManager.isArabic ? "وقت اللياقة" : "Fitness Time I",
//                                            subtitle: languageManager.isArabic ? "تتبع وقت التمارين" : "Track Your Workout Time",
//                                            iconName: "fitcal",
//                                            appId: "id6739770407",
//                                            colors: colors
//                                        )
...
//                                        AppListItem(
//                                            title: "SendSnap",
//                                            subtitle: languageManager.isArabic ? "مشاركة الصور بسهولة" : "Easy Photo Sharing",
//                                            iconName: "sendsnap",
//                                            appId: "id6736941131",
//                                            colors: colors
//                                        )
//                                        
//                                        AppListItem(
//                                            title: languageManager.isArabic ? "تحسين التخزين" : "Clean Guru",
//                                            subtitle: languageManager.isArabic ? "تنظيف وتحسين التخزين" : "Storage Optimization & Cleanup",
//                                            iconName: "cleanguru",
//                                            appId: "id6743487109",
//                                            colors: colors
//                                        )
...
//        let subject = "Budget Wallet Feedback"
//        let body = """
//        
//        
//        ---
...
//        
//        guard let emailURL = URL(string: mailtoString) else { return }
//        openURL(emailURL)
//    }
...
//    @Environment(\.openURL) var openURL
//    
//    // UPDATED: Added new apps to the URL mappings
...
//        
//        // NEW APPS ADDED
//        "الطقس": "https://apps.apple.com/ua/app/weather-forecast-sun-app/id1492430426",
//        "Weather": "https://apps.apple.com/ua/app/weather-forecast-sun-app/id1492430426",
//        "وقت اللياقة": "https://apps.apple.com/ua/app/fitness-time-i-%D9%88%D9%82%D8%AA-%D8%A7%D9%84%D9%84%D9%8A%D8%A7%D9%82%D8%A9/id6739770407",
//        "Fitness Time I": "https://apps.apple.com/ua/app/fitness-time-i-%D9%88%D9%82%D8%AA-%D8%A7%D9%84%D9%84%D9%8A%D8%A7%D9%82%D8%A9/id6739770407",
//        "SendSnap": "https://apps.apple.com/ua/app/sendsnap/id6736941131",
//        "تحسين التخزين": "https://apps.apple.com/ua/app/%D8%AA%D8%AD%D8%B3%D9%8A%D9%86-%D8%A7%D9%84%D8%AA%D8%AE%D8%B2%D9%8A%D9%86/id6743487109",
//        "Clean Guru": "https://apps.apple.com/ua/app/%D8%AA%D8%AD%D8%B3%D9%8A%D9%86-%D8%A7%D9%84%D8%AA%D8%AE%D8%B2%D9%8A%D9%86/id6743487109"
//    ]
//    
//    var body: some View {
//        Button {
...
struct SettinappView: View {
                ...
                SectionView(title: languageManager.isArabic ? "ساعدنا لتحسين تطبيقنا" : "Help us to improve our app") {
                    VStack(spacing: 12) {
                        ...
                        FeedbackButton(
                            ...
                            text: languageManager.isArabic ? "شاركنا اقتراحك" : "Share Your Feedback",
                            iconColor: Color(hex: "4CD964"),
                            action: { sendEmail(type: .feedback) }
                        )
                        .environmentObject(languageManager)
                        ...
                        FeedbackButton(
                            ...
                            text: languageManager.isArabic ? "لا تستمتع بالتطبيق؟" : "Not Enjoying the App?",
                            iconColor: Color(hex: "FF3B30"),
                            action: { sendEmail(type: .notEnjoying) }
                        )
                        .environmentObject(languageManager)
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(spacing: 12) {
                        AppListItem(
                            ...
                            appId: "id6736939515",
                            colors: colors,
                            isArabic: languageManager.isArabic  // Add this line
                        ...
                        // NEW APPS ADDED
                        AppListItem(
                            title: languageManager.isArabic ? "التقويم الهجري" : "Hegry",
                            subtitle: languageManager.isArabic ? "التقويم الهجري الدقيق" : "Accurate Hijri Calendar",
                            iconName: "hegry",
                            appId: "id6670756504",
                            colors: colors,
                            isArabic: languageManager.isArabic  // Add this line
                        ...
                        AppListItem(
                            title: "Kaaf",
                            subtitle: languageManager.isArabic ? "لوحة مفاتيح نستعليق" : "Nastaliq Fonts Keyboard",
                            iconName: "kaf",
                            appId: "id1644543252",
                            colors: colors,
                            isArabic: languageManager.isArabic  // Add this line
                        ...
                        AppListItem(
                            title: languageManager.isArabic ? "الدوره الشهريه" : "Period Tracker",
                            subtitle: languageManager.isArabic ? "تتبع الدورة الشهرية" : "Period & Pregnancy Tracker",
                            iconName: "dawra",
                            appId: "id6748580764",
                            colors: colors,
                            isArabic: languageManager.isArabic  // Add this line
                        ...
                        AppListItem(
                            title: languageManager.isArabic ? "تحويل الصور الى PDF" : "Photo to PDF",
                            subtitle: languageManager.isArabic ? "تحويل الصور إلى PDF" : "Convert Images to PDF",
                            iconName: "tahwel",
                            appId: "id6608976846",
                            colors: colors,
                            isArabic: languageManager.isArabic  // Add this line
                        ...
                        AppListItem(
                            title: languageManager.isArabic ? "وقت الراتب | رواتب السعودية" : "Saudi Salaries",
                            subtitle: languageManager.isArabic ? "رواتب القطاع الحكومي" : "Government Sector Salaries",
                            iconName: "rawateb",
                            appId: "id885010081",
                            colors: colors,
                            isArabic: languageManager.isArabic  // Add this line
    ...
    // UPDATED: Added email type enum and custom sendEmail function
    enum EmailType {
        case feedback
        case issue
        case notEnjoying
    ...
    private func sendEmail(type: EmailType) {
        // Get app version
        let appVersion = Bundle.main.infoDictionary?["CFBundleShortVersionString"] as? String ?? "Unknown"
        let buildNumber = Bundle.main.infoDictionary?["CFBundleVersion"] as? String ?? "Unknown"
        ...
        // Create custom subject based on email type
        let subject: String
        switch type {
        case .feedback:
            subject = "Budget Wallet Share Feedback"
        case .issue:
            subject = "Budget Wallet Having Issues"
        case .notEnjoying:
            subject = "Budget Wallet Not Enjoying App"
        }
...
struct AppListItem: View {
    ...
    let appId: String
    let colors: SettingsColors
    let isArabic: Bool  // Pass language state directly
    @Environment(\.openURL) var openURL
    ...
    private let appURLs: [String: String] = [
        ...
        // NEW APPS ADDED
        "التقويم الهجري": "https://apps.apple.com/us/app/%D8%A7%D9%84%D8%AA%D9%82%D9%88%D9%8A%D9%85-%D8%A7%D9%84%D9%87%D8%AC%D8%B1%D9%8A/id6670756504",
        "Hegry": "https://apps.apple.com/us/app/%D8%A7%D9%84%D8%AA%D9%82%D9%88%D9%8A%D9%85-%D8%A7%D9%84%D9%87%D8%AC%D8%B1%D9%8A/id6670756504",
        "Kaaf": "https://apps.apple.com/us/app/kaaf-nastaliq-fonts-keyboard/id1644543252",
        "الدوره الشهريه": "https://apps.apple.com/us/app/period-tracker-pregnancy-app/id6748580764",
        "Period Tracker": "https://apps.apple.com/us/app/period-tracker-pregnancy-app/id6748580764",
        "تحويل الصور الى PDF": "https://apps.apple.com/us/app/%D8%AA%D8%AD%D9%88%D9%8A%D9%84-%D8%A7%D9%84%D8%B5%D9%88%D8%B1-%D8%A7%D9%84%D9%89-pdf/id6608976846",
        "Photo to PDF": "https://apps.apple.com/us/app/%D8%AA%D8%AD%D9%88%D9%8A%D9%84-%D8%A7%D9%84%D8%B5%D9%88%D8%B1-%D8%A7%D9%84%D9%89-pdf/id6608976846",
        "وقت الراتب | رواتب السعودية": "https://apps.apple.com/us/app/%D9%88%D9%82%D8%AA-%D8%A7%D9%84%D8%B1%D8%A7%D8%AA%D8%A8-%D8%B1%D9%88%D8%A7%D8%AA%D8%A8-%D8%A7%D9%84%D8%B3%D8%B9%D9%88%D8%AF%D9%8A%D8%A9/id885010081",
        "Saudi Salaries": "https://apps.apple.com/us/app/%D9%88%D9%82%D8%AA-%D8%A7%D9%84%D8%B1%D8%A7%D8%AA%D8%A8-%D8%B1%D9%88%D8%A7%D8%AA%D8%A8-%D8%A7%D9%84%D8%B3%D8%B9%D9%88%D8%AF%D9%8A%D8%A9/id885010081"
    ]
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            .buttonStyle(ScaleButtonStyle())
            .frame(width: 80) // Fixed width for button
        }
        .padding(.horizontal, 16)
        .padding(.vertical, 12)
        .background(colors.cardBackground)
